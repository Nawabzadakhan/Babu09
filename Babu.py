...
print("\033[1;35m───────────────────────────────────────KHOF M4K3R BABU CHAHUAN ───────────────────────────") 
print("\033[1;35m─────DABBANG KI BH3N KA PYAR SMAILY─────────────────────────────────────────────────────────────") 
print("\033[1;35m────────DABBANG KI BH3N KA REP KRNE WALA BABU CHAHUAN  DON──────────────────────────────────────────────────────────") 
print("\033[1;35m────────────────DABBANG JOK3R KI BH3N KA SUHAR BABU CHAHUAN  DON──────────────────────────────────────────────────") 
print("\033[1;35m──────────────────────────────────────────────────────────────────") 
print("\n                     \033[38;2;124;252;0mCreated By: UNB34T9BL3 BOII BABU CHAHUAN  INSID3")
print("-----------------------------------------------------------------------")
...
def main():
    ...
    logo()
    print('-------------------------------------------')
    print("\033[1;34m Note >>  DABBANG KII BH9N KA YAR BABU 0N FIR3")
    print('-------------------------------------------')
    coki = input(' [+] Cookies : ')
    cookies={'cookie': coki}
    ...
    print('-------------------------------------------')
    delay = int(input(' [+] DABBANG KI BH3N CHODNA CH4LU : '))
    print('-------------------------------------------')
    lnk = input(' [+] DABBANG KI BH39 KI CHUT MAI LINK DAL / Link id : ')
    print('-------------------------------------------')
